...
from ObjectDetection.entity.artifact_entity import DataIngestionArtifact
...
class TrainPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        try:
            logging.info(
                "Entered the strat_data_ingestion method of TrainPipeline class"
            )
            ...
            logging.info(
                "Exited the strat_data_ingestion method of TrainPipeline class"
            )
